function renderVideoPopup (wrapper) {
    ...
    closePopupButton.id = "close-popup-button-1";
    ...
    `;
    closePopupButton.addEventListener("click", () => renderPage1(wrapper));
    ...
    videoContent.width = 432;
    videoContent.height = 932;
    videoContent.innerHTML = "Video kommer snart";
