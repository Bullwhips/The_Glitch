function renderGameCompleteListenPopup(wrapper){
  ...
  localStorage.setItem("currentPage", "renderGameCompletePopup");
    ...
    closePopupButtonVideo.innerHTML = `    
    ...
    closePopupButtonVideo.addEventListener("click", () => {
        ...
        renderGameFinish(wrapper);
    });
    closePopupButtonContainer.append(closePopupButtonVideo);

    let video = "https://youtube.com/shorts/bbROmolC_EA";
...
function renderGameCompleteSilentPopup(wrapper){
  ...
  localStorage.setItem("currentPage", "renderGameCompletePopup");
    ...
    let video = "https://youtube.com/shorts/YRSE8mlrZt0";
