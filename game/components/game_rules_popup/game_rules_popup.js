function renderGameRulesPopup (wrapper) {
    ...
    notes.id = "popup-text";
    notes.textContent = `
        📝 ANTECKNA - LÖS GÅTOR & SAMLA INFO<br>
    ...
    charachters.textContent = `
        👤 OLIKA KARAKTÄRER<br>
        Genom spelet kan ni möta fler karaktärer. 
        Var uppmärksam på signalement som kan känneteckna olika karaktärer.
    `;
