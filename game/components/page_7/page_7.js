function renderPage7(wrapper){
    localStorage.setItem("currentPage", "renderPage7");
    wrapper.innerHTML = "";
    ...
    function renderClueDiaryPopup(wrapper) {
        let diaryPopupContainer = document.createElement("div");
        diaryPopupContainer.id = "popup-container-short";
        diaryPopupContainer.classList.remove("hidden");
        diaryPopupContainer.classList.add("visible");
        pageContainer.classList.add("blur");
        wrapper.appendChild(diaryPopupContainer);
    
        let headTextRules = document.createElement("h2");
        headTextRules.id = "head-text-popup";
        headTextRules.textContent = "⚠ MEDDELANDE: <clue>";
        diaryPopupContainer.appendChild(headTextRules);
    
        let popupTextContainer = document.createElement("div");
        popupTextContainer.id = "popup-text-container-short";
        diaryPopupContainer.appendChild(popupTextContainer);
        ...
        diaryPopupContainer.append(closePopupButtonContainer);
    ...
    function renderGraceHopperPopup(wrapper) {
        ...
        graceHopperPopupContainer.appendChild(popupTextContainer);
        ...
        let closePopupButtonContainer = document.createElement("div");
        closePopupButtonContainer.id = "close-popup-button-container";
        graceHopperPopupContainer.append(closePopupButtonContainer);
        let closePopupButton = document.createElement("button");
        closePopupButton.id = "close-popup-button";
        closePopupButton.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 36 36" fill="none">
        ...
        closePopupButton.addEventListener("click", () => {
            graceHopperPopupContainer.remove();
            renderPage8(wrapper)
        });
        closePopupButtonContainer.append(closePopupButton);
